        ...
        elem.off('click').on('click', function (e) {
            ...
            if (opt.searchType == 'more') {
                $.each(opt.searchList, function (index, item) {
                    tableBox += '<input style="display:inline-block;width:150px;height:30px;vertical-align:middle;margin-right:-1px;border: 1px solid #C9C9C9;" type="text" name="' + item.searchKey + '" placeholder="' + item.searchPlaceholder + '" autocomplete="off" class="layui-input">';
                });
            } else {
                tableBox += '<input style="display:inline-block;width:150px;height:30px;vertical-align:middle;margin-right:-1px;border: 1px solid #C9C9C9;" type="text" name="' + opt.searchKey + '" placeholder="' + opt.searchPlaceholder + '" autocomplete="off" class="layui-input">';
            }
            ...
            tableBox += '</form>';
            tableBox += '<button style="float:right;margin-left:10px" class="layui-btn layui-btn-sm layui-btn-danger tableSelect_btn_noSelect">清空<span></span></button>';
            ...
            //按钮清空
            tableBox.find('.tableSelect_btn_noSelect').on('click', function () {
                var checkStatus = table.checkStatus(tableName);
                checkStatus.data = "";
